<div class="row">
    ...
    <a href="{{route('admin.users')}}" class="col-xl-3 col-md-6 mb-4">
    ...
    <!-- Earnings (Monthly) Card Example -->
    <a href="{{route('admin.categories')}}" class="col-xl-3 col-md-6 mb-4">
    ...
    <a href="{{route('admin.products')}}" class="col-xl-3 col-md-6 mb-4">
